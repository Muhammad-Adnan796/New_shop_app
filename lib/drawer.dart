...
import 'package:diagnose/pages/account2.dart';
...
import 'package:diagnose/pages/wish_list2.dart';
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => AppointmentsItem(),),);
                                },
                            child: SizedBox(
                                width: 150,
                                height: 25,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => WishList2(),),);
                                },
                            child: SizedBox(
                                width: 150,
                                height: 25,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          GestureDetector(
                            onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Setting2(),),);
                                },
                            child: SizedBox(
                                width: 150,
                                height: 25,
