...
class SendingStop extends StatefulWidget {
  const SendingStop({Key? key}) : super(key: key);

  @override
  State<SendingStop> createState() => _SendingStopState();
}

class _SendingStopState extends State<SendingStop> {
  @override
